...
class TestSemblendPackageImports:
    ...
    def test_version(self):
        import semblend
        assert semblend.__version__ == "0.1.0"
    ...
    def test_donor_store_import(self):
        from semblend import DonorMatch, DonorNode, DonorStore
    ...
    def test_simhash_import(self):
        from semblend import compute_simhash, hamming_distance, is_plausible_donor
